	...
	m := func(handler web.Handler) web.Handler {
		...
		h := func(ctx context.Context, w http.ResponseWriter, r *http.Request) error {
			...
			if err := handler(ctx, w, r); err != nil {
				...
				// if we receive the shutfown err we need to return it
				// back to the base handle to shutdown the service.
			...
			// The error has been handled sow e can stop propagating it.
			return nil
		}
		return h
	}
